...
public class AES {
    ...
    final static String cipherTransformation = "AES/CBC/PKCS5Padding";
    final static String aesEncryptionAlgorithm = "AES";
    ...
    public static byte[] decrypt(byte[] values, byte[] keyBytes) throws KeyException, GeneralSecurityException, GeneralSecurityException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException{
        //byte[] cipheredBytes = Base64.decode(values, Base64.DEFAULT);
        //byte[] keyBytes = getKeyBytes(key);
        return decrypt(values, keyBytes, keyBytes);
    }
