...
/*
    ...
    /// <param name="key">Secret Key</param>
    /// <returns>Decrypted String</returns>
    public static String decrypt(String cipherText, String key) throws GeneralSecurityException, IOException{
        byte[] cipherTextBytes = cipherText.getBytes(characterEncoding);
        byte[] keyBytes = getKeyBytes(key);
        return Base64.encodeToString(decrypt(cipherTextBytes, keyBytes, keyBytes), Base64.DEFAULT);
    }
*/
}
